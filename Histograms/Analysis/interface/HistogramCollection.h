#ifndef PLOTS_TOOLS_PLOTCOLLECTION
#define PLOTS_TOOLS_PLOTCOLLECTION
...
namespace rat{
  ...
  /***********************************************/
  /** \brief PlotCollection 
   * 
   * PlotCollection
   ***********************************************/
  template <class PlotIndex,class PlotType>
  class PlotCollection : public std::map<PlotIndex,PlotType*>{
  public:
    
    PlotCollection();
    PlotCollection(std::map<PlotIndex,TFile*> samples,std::string path);
